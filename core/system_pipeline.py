...
from core.discovery_engine_v2 import main as discovery_engine_v2
...
def main():
    ...
    run_step("core.discovery_engine_v2", discovery_engine_v2)
    ...
    run_step("core.strategy_router", strategy_router)
    run_step("core.funding_recovery_engine", funding_recovery_engine)
    run_step("core.stat_arb_engine", stat_arb_engine)
    run_step("core.capital_allocator", capital_allocator)
